...
public class GenericsBasics {
    ...
    //   - This demonstrates why ? extends T is safe for reading but requires a generic method for writing
    ...
    public static double sumOfNumbers(List<? extends Number> numbers) {
        ...
        return numbers.stream().reduce(0.0, (subTotal, number) -> subTotal + number.doubleValue(), Double::sum);

 ...
 *
 * Implement the methods below using:
 * - Text Blocks (triple-quoted multi-line strings with """)
 * - Unnamed variables (_ in lambdas, catch blocks, for-loops, try-with-resources)
 * - Text Block formatting: indent trimming, \s, \n, \
 */
public class TextBlocksAndUnnamedVars {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(findIndicesStartingWithA(java.util.List.of("Apple", "Banana", "Avocado", "Cherry")));
        System.out.println();

        System.out.println("TODO 6 - Swallow Exception:");
        System.out.println(swallowException(() -> { throw new RuntimeException("fail"); }));
        System.out.println();
